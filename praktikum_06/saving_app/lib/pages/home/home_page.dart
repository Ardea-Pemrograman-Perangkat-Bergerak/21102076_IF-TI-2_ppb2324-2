...
class HomePage extends StatelessWidget {
                            ...
                            child: Column(
                              children: [
                                ...
                                SizedBox(
                                  height: 31,),
                                _transactionList(
                                  kTreeGreen.withOpacity(0.2), 'assets/icons/triangle-up.png', 
                                  'Success', 
                                ...
                                _transactionList(
                                  kOrange.withOpacity(0.2), 'assets/icons/triangle-down.png', 
                                  'Starbucks Drinks', 
  ...
  Color backgroundColor, String icon, String title, String sub, String amount) {
   return Padding(
